...
- [AOZ-Studio/AMOS-Professional-Official](https://github.com/AOZ-Studio/AMOS-Professional-Official) - The official source code of AMOS Professional on the Amiga
...
- [processone/erlang-sqlite3](https://github.com/processone/erlang-sqlite3) - Sqlite gen_server port for Erlang. Creates, reads and writes to sqlite database. 
...
- [russor/crazierl](https://github.com/russor/crazierl) - An Erlang Operating System for x86
...
- [trealla-prolog/trealla-prolog](https://github.com/trealla-prolog/trealla-prolog) - A compact, efficient Prolog interpreter written in plain old C.
...
- [thepushkaraj/TechCreators](https://github.com/thepushkaraj/TechCreators) - A website to list tech twitter creators, across the world.
...
- [Kiruse/cw-pipeline](https://github.com/Kiruse/cw-pipeline) - Kiru's tools for CosmWasm Developers
...
- [amygdala-labs/heighliner](https://github.com/amygdala-labs/heighliner) - Repository of docker images for the node software of Cosmos chains
...
- [samrose/datalox](https://github.com/samrose/datalox) - datalog in elixir
...
- [bwireman/go-over](https://github.com/bwireman/go-over) - A tool to audit Hex dependencies, to make sure your ✨ gleam projects really sparkle!
...
- [AidanThomas/ledger](https://github.com/AidanThomas/ledger) - A TUI app for interacting with SQL databases
...
- [AstraBert/workflows-go](https://github.com/AstraBert/workflows-go) - An implementation of event-driven workflows in Go
...
- [ad2ien/help-the-stars](https://github.com/ad2ien/help-the-stars) - Don't miss help wanted issues of the repo you stared
...
- [albttx/traefik-plugin-x402](https://github.com/albttx/traefik-plugin-x402) - traefik plugin for processing x402 payments
...
- [amygdala-labs/cosmos-operator](https://github.com/amygdala-labs/cosmos-operator) - Cosmos Operator is a kubernetes operator for managing cosmos nodes
- [amygdala-labs/half-life](https://github.com/amygdala-labs/half-life) - Cosmos validator monitoring and alerting utility
- [amygdala-labs/horcrux](https://github.com/amygdala-labs/horcrux) - Threshold HA CometBFT/Tendermint remote signer
- [amygdala-labs/interchaintest](https://github.com/amygdala-labs/interchaintest) - e2e testing framework for the interchain
- [amygdala-labs/lens](https://github.com/amygdala-labs/lens) - ⚛️❤️👁 Brought to you by the LensCrafters
- [amygdala-labs/poa](https://github.com/amygdala-labs/poa) - Cosmos Proof-of-Authority module for private & permissioned networks
...
- [ark-us/wasmx](https://github.com/ark-us/wasmx) - The only WASM-modular blockchain engine capable of regeneration and metamorphosis. Multi VM, language-agnostic, general & domain-specific language interpreters, variety of host APIs.
...
- [asynkron/Asynkron.QuickDup](https://github.com/asynkron/Asynkron.QuickDup) - AI-era code clone detector using structural shape fingerprinting
...
- [evstack/celestia-da](https://github.com/evstack/celestia-da) - Celestia Implementation of Modular Data Availability Interface
- [evstack/ev-node](https://github.com/evstack/ev-node) - A modular framework for building performant networks, pushing the boundary of today in order to build the apps of tomorrow. 
- [evstack/go-da](https://github.com/evstack/go-da) - Generic Data Availability Interface for Modular Blockchains
- [evstack/go-execution](https://github.com/evstack/go-execution) - A generic execution api for rollups
...
- [hyperledger-labs/yui-relayer](https://github.com/hyperledger-labs/yui-relayer) - IBC Relayer implementations for heterogeneous blockchains
...
- [ignite/apps](https://github.com/ignite/apps) - Ignite Apps
...
- [initia-labs/OPinit](https://github.com/initia-labs/OPinit) - Initia optimistic rollup Cosmos SDK modules
- [initia-labs/initia](https://github.com/initia-labs/initia) - Initia L1 source code
- [initia-labs/minievm](https://github.com/initia-labs/minievm) - Interwoven Rollup with EVM
- [initia-labs/minimove](https://github.com/initia-labs/minimove) - Interwoven Rollup with MoveVM
- [initia-labs/miniwasm](https://github.com/initia-labs/miniwasm) - Interwoven Rollup with WasmVM
...
- [janos/singleflight](https://github.com/janos/singleflight) - Duplicate function call suppression with context
...
- [julienrbrt/chain-minimal](https://github.com/julienrbrt/chain-minimal) - Minimal Cosmos SDK chain template
- [julienrbrt/example](https://github.com/julienrbrt/example) - Cosmos SDK Module Template
...
- [knadh/tinyauth](https://github.com/knadh/tinyauth) - Tiny, opinionated authentication library for Go. Work in progress and not usable right now.
...
- [louisho5/picobot](https://github.com/louisho5/picobot) - A lightweight self-hosted bot in a single binary, written in Go.
...
- [rchakode/hugo-mx-gateway](https://github.com/rchakode/hugo-mx-gateway) - :mailbox_with_no_mail: Contact/demo form handler for static websites with spam protection. Deploy on Kubernetes, Google Compute Engine, or Docker. Built for Hugo and other static site generators.
...
- [schmich/sfs](https://github.com/schmich/sfs) - HTTP Static File Server and Proxy
...
- [shayan-shojaei/radar](https://github.com/shayan-shojaei/radar) - An interactive terminal API explorer for OpenAPI / Swagger specifications.
...
- [skip-mev/connect](https://github.com/skip-mev/connect) - A general purpose oracle leveraging ABCI++
...
- [xgo-dev/c2go](https://github.com/xgo-dev/c2go) - Convert C to Go
...
- [ziggy42/epsilon](https://github.com/ziggy42/epsilon) - A WASM virtual machine written in Go with 0 dependencies
...
- [LLM-Coding/Semantic-Anchors](https://github.com/LLM-Coding/Semantic-Anchors) - 
...
- [HaxeFoundation/hscript](https://github.com/HaxeFoundation/hscript) - Parser and interpreter for Haxe expressions
- [ncannasse/picogpu](https://github.com/ncannasse/picogpu) - Pico GPU is a 300KB memory GPU intended to learn, experiment and have fun with shaders and sound synthesis.
...
- [green-code-initiative/creedengo-java](https://github.com/green-code-initiative/creedengo-java) - Reduce the environmental footprint of your Java software programs
...
- [jsprhzn/quarkus-axonframework-extension](https://github.com/jsprhzn/quarkus-axonframework-extension) - Quarkus Axon Framework extension
...
- [asynkron/asynkron-skills](https://github.com/asynkron/asynkron-skills) - ASYNKRON developer tools skills — profiler, test runner, code duplication detector, and line counter
...
- [bhousel/node-diff3](https://github.com/bhousel/node-diff3) - A JavaScript library for text diffing and three-way-merge
...
- [dataplane-app/dataplane](https://github.com/dataplane-app/dataplane) - Dataplane is an Airflow inspired unified data platform with additional data mesh and RPA capability to automate, schedule and design data pipelines and workflows. Dataplane is written in Golang with a React front end.
...
- [fetchai/genesis-fetchhub](https://github.com/fetchai/genesis-fetchhub) - repo for launching Stargate upgrade of Fetch.ai mainnet
- [fission/fission-ui](https://github.com/fission/fission-ui) - Fission web interface
- [fransooi/STAS](https://github.com/fransooi/STAS) - STOS Basic in command-line and ASCII-ART - soon part of the AWI Ecosystem
...
- [kunwl123456/zeroclaw-skills-collection](https://github.com/kunwl123456/zeroclaw-skills-collection) - Recommended skills for ZeroClaw
...
- [multiversx/mx-docs](https://github.com/multiversx/mx-docs) - 
...
- [orbitdb/simple-encryption](https://github.com/orbitdb/simple-encryption) - A simple password encryption module that encrypts data using AES-GCM PBKDF2.
...
- [sea-monkeys/WASImancer](https://github.com/sea-monkeys/WASImancer) - 
...
- [takahirox/three.wasm-experimental](https://github.com/takahirox/three.wasm-experimental) - Experimental Three.js WASM (WIP)
...
- [axone-protocol/template-go](https://github.com/axone-protocol/template-go) - 🖨 Template for Golang projects @axone-protocol.
...
- [dawid-dahl-umain/augmented-ai-development](https://github.com/dawid-dahl-umain/augmented-ai-development) - A Disciplined TDD Approach to AI-Assisted Software Development
...
- [AaronFriel/qmodem-4.51](https://github.com/AaronFriel/qmodem-4.51) - 
...
- [DBvc/agent-skill-control-theory](https://github.com/DBvc/agent-skill-control-theory) - A First-Principles Framework for LLM Agent Skills
...
- [Luminara-Hub/namada-ecosystem](https://github.com/Luminara-Hub/namada-ecosystem) - 
...
- [SpillwaveSolutions/agent-brain](https://github.com/SpillwaveSolutions/agent-brain) - Local-first RAG memory for AI agents: hybrid + GraphRAG search, MCP server with OAuth 2.1, plugin for Claude Code / OpenCode / Codex.
...
- [agent37-platform/agent37-skills-collection](https://github.com/agent37-platform/agent37-skills-collection) - Collection of useful Claude AI skills and commands
...
- [danielmeppiel/genesis](https://github.com/danielmeppiel/genesis) - Markdown that steers an LLM is code. Genesis is the architectural layer for designing multi-agent, multi-skill systems -- with named patterns, contracts, and substrate portability, before you write them.
...
- [nonatofabio/local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp) - Local FAISS vector store as an MCP server – Agent Memory, drop-in local semantic search for Claude / Copilot / Agents.
...
- [orseni/codex-remote-hub](https://github.com/orseni/codex-remote-hub) - 
...
- [quodeq/quodeq](https://github.com/quodeq/quodeq) - AI-powered code quality and security scanner. Open source, MIT, runs locally. &lt;🧭&gt;
...
- [fluent-plugins-nursery/fluent-plugin-kubernetes_metadata_filter](https://github.com/fluent-plugins-nursery/fluent-plugin-kubernetes_metadata_filter) - Enrich your fluentd events with Kubernetes metadata
...
- [AS-FOSS/mandible](https://github.com/AS-FOSS/mandible) - A Universal TUI Manual Viewer for CLI Tools in Rust
...
- [ChmaraX/herdr-nvim](https://github.com/ChmaraX/herdr-nvim) - Neovim, fully integrated into your herdr workspace
...
- [afogel/shepherdr](https://github.com/afogel/shepherdr) - Shepherd delegated coding agents into visible, auditable herdr panes you can watch, resume, and take over — a herdr plugin.
...
- [alexandretrotel/dotfiles-manager](https://github.com/alexandretrotel/dotfiles-manager) - Keep your dotfiles organized, safe, and consistent across machines using profiles.
...
- [amimart/collette](https://github.com/amimart/collette) - Collette - Typed collections, indexes and scans over KV stores
...
- [burnt-labs/cw-counter](https://github.com/burnt-labs/cw-counter) - This is a basic CosmWasm smart contract that allows you to set a counter and then either increment or reset it. You can also query the current counter value.
...
- [eastreams/loong](https://github.com/eastreams/loong) - Lightweight, clear, and fully extensible AI agent infrastructure — learn easily, customize anything 🐉
- [eliasstravik/herdr-projects](https://github.com/eliasstravik/herdr-projects) - A coordinator conversation, parallel worker threads, shared memory and an overview of what needs you. A Herdr plugin.
...
- [equilibriumco/beerus](https://github.com/equilibriumco/beerus) - A stateless trustless Starknet light client in Rust 🦀
...
- [ethereum/sonobe](https://github.com/ethereum/sonobe) - Experimental folding schemes library
...
- [kenianbei/plurimus-doom](https://github.com/kenianbei/plurimus-doom) - Doom in the terminal, for testing the bevy/ratatui rendering library plurimus.
...
- [lantr-io/rustus](https://github.com/lantr-io/rustus) - Rustus - yet another smart contract programming language for Cardano
...
- [lelabdev/rag-ferrite](https://github.com/lelabdev/rag-ferrite) - Personal RAG engine — simple, fast, Rust. One binary (15 MB), one DB, native collections. MCP-native.
...
- [namada-net/namada-indexer](https://github.com/namada-net/namada-indexer) - Namada indexer to be used in conjunction with the namada interface
...
- [nunchi-labs/sdk](https://github.com/nunchi-labs/sdk) - financial primitives for commonware chains
...
- [privacy-ethereum/halo2curves](https://github.com/privacy-ethereum/halo2curves) - 
...
- [raphaelmansuy/edgecrab](https://github.com/raphaelmansuy/edgecrab) - EdgeCrab 🦀 A Super Powerful Personal Assistant inspired by NousHermes and OpenClaw — Rust-native, blazing-fast terminal UI, ReAct tool loop, multi-provider LLM support, ACP protocol, gateway adapters, and built-in security hardening. 
- [raphamorim/rio](https://github.com/raphamorim/rio) - A hardware-accelerated GPU terminal emulator focusing to run in desktops and browsers.
- [ratatui/ratatui](https://github.com/ratatui/ratatui) - A Rust crate for cooking up terminal user interfaces (TUIs) 👨‍🍳🐀 https://ratatui.rs
- [ratatui/ratatui-spinner](https://github.com/ratatui/ratatui-spinner) - Customizable, stateless spinner widgets for Ratatui applications
...
- [terra-money/cosmwasm-contracts](https://github.com/terra-money/cosmwasm-contracts) - 
- [theinterfold/interfold](https://github.com/theinterfold/interfold) - An open-source protocol and distributed network for confidential coordination.
...
- [1Password/agent-hooks](https://github.com/1Password/agent-hooks) - Our collection of hooks built for AI agents
...
- [OSWatcher/oswatcher](https://github.com/OSWatcher/oswatcher) - 
...
- [johannjhang/git-fast-forward-all-branches](https://github.com/johannjhang/git-fast-forward-all-branches) - 
...
- [nilbuild/claude-statusline](https://github.com/nilbuild/claude-statusline) - Minimal Claude Code statusline setup I personally use
...
- [nodejumper-org/monitoring-tool](https://github.com/nodejumper-org/monitoring-tool) - A powerful and easy-to-use monitoring tool for server hardware and validator nodes with alerts via telegram bot
...
- [ping-pub/mainnet](https://github.com/ping-pub/mainnet) - The deployment of ping.pub, submit your chain config here
...
- [renard/tikz-penciline](https://github.com/renard/tikz-penciline) - Simulate hand drawing in LaTeX PGF/TikZ
...
- [Baylar55/omp-undo-redo](https://github.com/Baylar55/omp-undo-redo) - A small extension for session and file undo/redo in Oh My Pi and Pi agent harness
...
- [SonarSource/sonarqube-cli](https://github.com/SonarSource/sonarqube-cli) - Command-line interface for SonarQube with AI agent integration. Scan for secrets and get fast feedback on code quality and security from your terminal.
...
- [Sphereon-Opensource/SSI-SDK](https://github.com/Sphereon-Opensource/SSI-SDK) - (Legacy) Self Sovereign Identity SDK
...
- [axone-protocol/doctai](https://github.com/axone-protocol/doctai) - 🩺  AI agent demo running on the Axone protocol for collaborative medical diagnosis.
...
- [gracefullight/docusaurus-plugins](https://github.com/gracefullight/docusaurus-plugins) - A collection of Docusaurus plugins for analytics, chat, ads, error tracking, copy-as-markdown, and more.
...
- [hazae41/visage](https://github.com/hazae41/visage) - QR code encoding for the web
...
- [jadujoel/markdown-to-jira](https://github.com/jadujoel/markdown-to-jira) - Create jira compatible text from markdown
...
- [multiversx/mx-template-dapp](https://github.com/multiversx/mx-template-dapp) - MultiversX React dApp Template: wallet auth, transaction signing and native auth using sdk-dapp v5. Built with React 18, TypeScript and Vite.
...
- [neohaskell/neohaskell.github.io](https://github.com/neohaskell/neohaskell.github.io) - Home of the NeoHaskell docs
...
- [osolmaz/pi-workflows](https://github.com/osolmaz/pi-workflows) - Workflow engine, JSON control-flow tool, and live terminal viewer for the pi coding agent
...
- [pohi-protocol/pohi](https://github.com/pohi-protocol/pohi) - Proof of Human Intent (PoHI) - Cryptographically verifiable human approval for AI-driven development
...
- [react-component/select](https://github.com/react-component/select) - 🎯 Composable Select component for React, with search, async-friendly option data, custom rendering, and virtual scrolling.
...
- [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) - Local-first RAG server for developers. Semantic + keyword search for code and technical docs. Works with MCP or CLI. Fully private, zero setup.
...
- [carvel-dev/ytt.vim](https://github.com/carvel-dev/ytt.vim) - syntax for ytt
...
- [CristinaSolana/solana-developer-resources](https://github.com/CristinaSolana/solana-developer-resources) - Solana Developer Resources
- [Cumulo-pro/Axone](https://github.com/Cumulo-pro/Axone) - 
...
- [alexdolbun/awesome-url-shortener](https://github.com/alexdolbun/awesome-url-shortener) - 🔗 A curated list of awesome url shortener
...
- [dfinke/awesome-copilot-chatmodes](https://github.com/dfinke/awesome-copilot-chatmodes) - Custom chatMode.md personas for GitHub Copilot — specialize your VS Code with AI assistants for testing, security, clean‑code refactoring, dashboards, prompt design, and more. Just drop in and select your mode.
...
- [pleaseproject/awesome-piracy](https://github.com/pleaseproject/awesome-piracy) - A curated list of awesome warez and piracy links
